...
snakemake --cores 8 results/tracking/idpvm.comparison.primary.tracking_eager.vs.tracking_ampac.MuonPU0.txt --sdm conda  --set-threads run_idpvm=4 run_gnn4itk_triton=1 --config max_evts=100 --dry-run
